...
knowledge0 = And(knowledge, Implication(AKnight, And(AKnight, AKnave)), 
...
# B says nothing.
knowledge1 = And( knowledge, Implication(AKnight, And(AKnave, BKnave)),
...
knowledge2 = And(knowledge,  Implication(AKnight, Or(And(AKnight, BKnight), And(AKnave, BKnave))),
